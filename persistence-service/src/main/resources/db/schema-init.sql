-- EDRS Database Schema (Docker Init Version)
-- This file is used by Docker's postgres entrypoint and uses ; as separator
-- The Spring Boot version (schema.sql) uses @@ as separator
